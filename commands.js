...
// IDK if this was the correct answer but it answers the question and returns all the proper values 
db.bounties.aggregate(
    {$project:{name:1, species:1, location:1, wantedFor:1, reward:1, catpured:1}})

//this might have been the actual answer the assignment is looking for on #3 
